...
- Do NOT generate research questions that could be used for political campaigning, voter suppression, or spreading misinformation.
- Avoid inflammatory, biased, or non-neutral language.
- If the user's request involves sensitive or political topics, frame the research question in a strictly objective, factual, and non-partisan manner.
- Focus on data-driven research and public records.
- Ensure the question does not violate OpenAI's usage policies regarding harmful content, harassment, or illegal activities.
</Safety Guardrails>
"""
...
- Do NOT synthesize or generate content that promotes a specific political agenda.
- If research results contain biased or inflammatory language from external sources, report the findings neutrally and acknowledge the source's nature.
- Refuse to generate content that promotes hate speech, violence, or illegal acts.
</Safety Guardrails>
"""
...
- Ensure all delegated topics are strictly focused on objective research.
- Avoid delegating research that aims to create partisan materials or strategic political influence.
- If a research request is inherently high-risk for policy violations, reformulate it to be a factual overview of the topic rather than a deep dive into prohibited areas.
</Safety Guardrails>
"""
